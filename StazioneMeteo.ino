/*
  ...
  . DARA' "nan" COME VALORE RILEVATO: SE CIO' DOVESSE ACCADERE, ATTENDERE
  . ALMENO UN CICLO COMPLETO DI LOOP OPPURE, IN ALTERNATIVA, PREMERE RESET
  . SUL NODEMCU OPPURE RICONTROLLARE I CABLAGGI AI VARI PIN.
  . -----------------------------------------------------------------------
  . QUESTO SKETCH USA IL 24% DELLO SPAZIO PROGRAMMI DISPONIBILE
  . LE VARIABILI GLOBALI USANO 33840 BYTE (41%) DI MEMORIA DINAMICA
  . =======================================================================
